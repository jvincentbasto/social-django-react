...
export const SectionSearchLeftTabsSample = () => {
  const list = range(randomNumber(4, 7));

  return (
    <div className="w-full max-w-[400px] max-md:max-w-[300px] max-lg:hidden flex flex-col gap-[20px]">
      {list.map((i) => {
        return <SectionSearchLeftTabs key={i} />;
      })}
    </div>
  );
};

const SectionSearchLeftTabs = () => {
...
export default SectionSearchLeftTabs;
